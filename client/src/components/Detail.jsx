...
export default function Detail() {
    ...
    return (
        <div className='containerDetail'>
            ...
            <div className='atributes'> <span className={'attributeDetailTitle'}>  Weight: </span>  <span>{dog.min_weight} - {dog.max_weight}  kg </span></div>
            <div className='atributes'> <span className={'attributeDetailTitle'}> Height:</span>  <span>{dog.min_height} - {dog.max_height} cms</span></div>
